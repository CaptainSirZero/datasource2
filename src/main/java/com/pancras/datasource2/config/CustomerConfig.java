...
@EnableJpaRepositories(
        basePackages = "com.pancras.datasource2.repository.jpa.customer",
...
public class CustomerConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("com.pancras.datasource2.domain.customer")
    ...
    @Primary
    public EntityManager entityManager(EntityManagerFactoryBuilder builder, @Qualifier("customerDataSource") DataSource dataSource) {
